...
describe User do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録がうまくいくとき' do
      it "nickname\b,email,password,password_confirmation,first_name_kanji,last_name_kanji,first_name_kana,last_name_kana,date_of_birthが存在すれば登録できる" do
    ...
    context '新規登録がうまくいかない時' do
      ...
      it 'first_name_kanjiに全角(漢字、ひらがな、カタカナ)以外を入力した場合、登録できない' do
        @user.first_name_kanji = "testてス\b十"
        @user.valid?
      ...
      it 'last_name_kanjiに全角(漢字、ひらがな、カタカナ)以外を入力した場合、登録できない' do
        @user.last_name_kanji = "TESTてス\b十"
        @user.valid?
